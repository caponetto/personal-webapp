...
export const ABOUT_DATA: AboutData = {
  paragraphs: [
    "Hi, there! My name is Guilherme Caponetto. I am currently working as a Senior Software Engineer at Red Hat, where I build tools for developers. I am a huge fan of the open-source community and I am always excited about building pieces of software that improve people's lives.",
    ...
    "Feel free to reach out to me on my social networks. I am always open to discussing new ideas and opportunities.",
  ],
};
